    ...
    -->
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <!-- <li class="nav-item {{Request::is('suit_type') ? 'active' :''}}">
            <a class="nav-link" href="{{url('suit_type')}}">
          ...
          <!-- <li class="nav-item {{Request::is('waist_coat') ? 'active' :''}}">
            <a class="nav-link" href="{{url('waist_coat')}}">
              <i class="material-icons">person</i>
              <p>Waist coat</p>
            </a>
          </li> -->
